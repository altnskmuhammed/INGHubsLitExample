...
nav {
  ...
  align-items: center;
  height: 100%; /* nav, hostun yüksekliğini doldursun */
}
  ...
  selectLang(lang) {
    ...
    // Burada i18n değişimi yap
    // Örnek: i18next.changeLanguage(lang)
    changeLang(lang)
        ...
        <div class="menu-links">
          ...
          <div class="lang-dropdown" @click=${this.toggleDropdown}>
            ...
            <div class="lang-options">
              ${Object.entries(flags).map(([key, src]) => html`
                <div class="lang-option" @click=${() => this.selectLang(key)}>
                  <img src="${src}" alt="${key}" />
                  ${key.toUpperCase()}
                </div>
              `)}
